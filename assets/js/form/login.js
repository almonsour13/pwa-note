...
function login(){
    ...
    <div class="card col-sm-6 col-md-6 col-lg-4 shadow-sm p-2">
        <div class="card-header border-0 bg-transparent">
            <h1 class="h2 app-name text-center text-gray-800 font-weight-bold p-2">Notch</h1>
...
function signup(){
    ...
    `<div class="container-fluid row justify-content-center align-items-center vh-100 p-0 m-0">
        <div class="card col-sm-6 col-md-6 col-lg-4 shadow-sm p-2">
            <div class="card-header border-0 bg-transparent">
                <h1 class="h2 text-center app-name text-gray-800 font-weight-bold p-2">Notch</h1>
